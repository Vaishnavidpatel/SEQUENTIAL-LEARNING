...
expName = 'sequential_learning_6_vaishnavi'  # from the Builder filename that created this script
expInfo = {
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/vaishnavipatel/Downloads/sequential_learning_6_vaishnavi_lastrun.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    trials_2 = data.TrialHandler(nReps=24.0, method='fullRandom', 
        ...
        trialList=data.importConditions('/Users/vaishnavipatel/Downloads/sequential_learning.csv'),
        ...
        for thisTrial in trials:
            ...
            while continueRoutine:
                ...
                if key_resp.status == STARTED and not waitOnFlip:
                    theseKeys = key_resp.getKeys(keyList=['null'], ignoreKeys=["escape"], waitRelease=False)
